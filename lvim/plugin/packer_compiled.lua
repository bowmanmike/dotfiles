...
_G.packer_plugins = {
  ["astronauta.nvim"] = {
    loaded = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/start/astronauta.nvim"
  },
  ["auto-pairs"] = {
    loaded = true,
  ...
  ["formatter.nvim"] = {
    ...
    loaded = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/start/formatter.nvim"
  },
  ["friendly-snippets"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/friendly-snippets"
  },
  ["galaxyline.nvim"] = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20core.galaxyline\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["nvim-autopairs"] = {
    ...
    loaded = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/start/nvim-autopairs"
  },
  ["nvim-comment"] = {
  ...
  ["nvim-compe"] = {
    ...
    loaded = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lint"] = {
    config = { "\27LJ\2\n9\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\16core.linter\frequire\0" },
    loaded = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/start/nvim-lint"
  },
  ["nvim-lsp-ts-utils"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/nvim-lsp-ts-utils"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-toggleterm.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/nvim-toggleterm.lua"
  },
  ["nvim-tree.lua"] = {
  ...
  ["vim-elixir"] = {
    loaded = false,
    needs_bufread = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vim-elixir"
  },
  ["vim-fugitive"] = {
    loaded = true,
  ...
  ["vim-rooter"] = {
    ...
    loaded = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/start/vim-rooter"
  },
  ["vim-surround"] = {
    loaded = true,
  ...
  ["vim-vsnip"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vim-vsnip"
  },
  vimtex = {
    loaded = false,
    needs_bufread = true,
    path = "/Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vimtex"
  },
  ["which-key.nvim"] = {
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dashboard-nvim', 'nvim-toggleterm.lua', 'which-key.nvim', 'barbar.nvim', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
...
time([[Sourcing ftdetect script at: /Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vimtex/ftdetect/tex.vim]], true)
vim.cmd [[source /Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vimtex/ftdetect/tex.vim]]
time([[Sourcing ftdetect script at: /Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vimtex/ftdetect/tex.vim]], false)
time([[Sourcing ftdetect script at: /Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vim-elixir/ftdetect/elixir.vim]], true)
vim.cmd [[source /Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vim-elixir/ftdetect/elixir.vim]]
time([[Sourcing ftdetect script at: /Users/mbowman/.local/share/lunarvim/site/pack/packer/opt/vim-elixir/ftdetect/elixir.vim]], false)
vim.cmd("augroup END")
