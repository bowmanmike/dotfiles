...
nvim_lsp.rust_analyzer.setup({ on_attach = on_attach, cmd={"/Users/mikebowman/Library/Application Support/Code/User/globalStorage/matklad.rust-analyzer/rust-analyzer-x86_64-apple-darwin"} })
